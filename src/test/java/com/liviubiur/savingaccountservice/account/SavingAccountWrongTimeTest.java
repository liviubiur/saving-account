...
import com.liviubiur.savingaccountservice.configuration.MockClockScheduleConfig;
...
@SpringBootTest(webEnvironment = RANDOM_PORT,
    classes = {SavingAccountServiceApplication.class, MockClockScheduleConfig.class})
@ActiveProfiles("test")
