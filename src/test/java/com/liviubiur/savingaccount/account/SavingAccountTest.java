package com.liviubiur.savingaccount.account;

import com.liviubiur.savingaccount.SavingAccountApplication;
import com.liviubiur.savingaccount.account.persistence.entity.SavingAccount;
import com.liviubiur.savingaccount.configuration.MockClockConfig;
...
import static com.liviubiur.savingaccount.user.SecurityConfigurationTest.asJsonString;
...
@SpringBootTest(webEnvironment = RANDOM_PORT,
    classes = {SavingAccountApplication.class, MockClockConfig.class})
@ActiveProfiles("test")
