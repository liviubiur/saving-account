...
import com.liviubiur.savingaccount.configuration.MockClockScheduleConfig;
import com.liviubiur.savingaccount.user.SecurityConfigurationTest;
...
@SpringBootTest(webEnvironment = RANDOM_PORT,
    classes = {SavingAccountApplication.class, MockClockScheduleConfig.class})
@ActiveProfiles("test")
